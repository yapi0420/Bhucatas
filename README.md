# 注意:此項目幾乎全由克勞德編寫代碼，由人為整理，僅供學習參考
<div align="center">
...
<img src="https://img.shields.io/badge/北华大学-猫猫校园-ff69b4?style=for-the-badge&logo=data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAzNiAzNiI+PHRleHQgeT0iMjgiIGZvbnQtc2l6ZT0iMjgiPvCfkLE8L3RleHQ+PC9zdmc+" alt="猫猫校园">
...
pandas==2.1.3
❓ 常见问题
<details> <summary><b>Q: 前端启动后显示"无法连接到后端服务"？</b></summary>
...
</details><details> <summary><b>Q: 页面文字颜色看不清怎么办？</b></summary>
...
</details><details> <summary><b>Q: 为什么前端目录用 `views/` 而不是 `pages/`？</b></summary>
Streamlit 会自动将 pages/ 目录识别为内置多页面导航功能，在侧边栏生成额外的页面链接，与我们自定义的导航系统冲突。因此必须重命名为 views/。

</details><details> <summary><b>Q: 如何切换到 MySQL 数据库？</b></summary>
安装 MySQL 驱动：pip install pymysql
创建数据库：CREATE DATABASE campus_cat CHARACTER SET utf8mb4;
修改 backend/database.py：

DATABASE_URL = "mysql+pymysql://root:password@localhost:3306/campus_cat?charset=utf8mb4"
重启后端，自动建表并填充种子数据。
</details><details> <summary><b>Q: 如何部署到服务器？</b></summary>
